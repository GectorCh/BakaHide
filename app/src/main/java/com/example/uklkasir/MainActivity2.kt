...
class MainActivity2 : AppCompatActivity() {
    ...
    lateinit var GroleUser: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GroleUser = findViewById(R.id.GroleUser)
        ...
        GroleUser.text = "Anda Login Sebagai " + role
                ...
                try{
                    when(direction){
                        ItemTouchHelper.LEFT -> {
                            ...
                            Toast.makeText(applicationContext, "Yay! Berhasil Terhapus!", Toast.LENGTH_SHORT).show()
                        }
                    ...
                    Toast.makeText(applicationContext, "Lah kok error?", Toast.LENGTH_SHORT).show()
                }
            }
        }
